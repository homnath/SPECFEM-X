...
step3: produce mesh and BC files
  >>exodus2mesh mesh.txt
  OR
  >>exodus2mesh mesh.txt 1000.0
...
COMPILE:
  gcc exodus2mesh.c -o exodus2mesh
USAGE: 
  exodus2mesh <inputfile> <OPTIONS>
  Example: exodus2mesh sloep3d_mest.txt
  or
  exodus2mesh slope3d_mesh.e -fac=0.001 -bin=1
OPTIONS:
