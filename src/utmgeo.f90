...
subroutine geodetic2utm(rlon4,rlat4,rx4,ry4)
...
end subroutine geodetic2utm
!===============================================================================

subroutine utm2geodetic(rx4,ry4,rlon4,rlat4)
...
! input/output parameters
double precision,intent(in) :: rx4,ry4
double precision,intent(out) :: rlon4,rlat4
